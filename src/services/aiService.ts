...
function buildProjectAskInstructions(mode: ProjectAskMode): string {
  const common = [
    ...
    "8. N'invente jamais une fonction, un fichier, une décision ou un besoin.",
    "9. Si une responsabilité a été déplacée entre fichiers, suis les appels jusqu'au fichier qui implémente réellement le comportement.",
    "10. N'invente jamais une fonction, un fichier, une décision ou un besoin.",
    "11. Quand une information n'est pas déterminable, dis-le plutôt que de l'imaginer.",
    "",
