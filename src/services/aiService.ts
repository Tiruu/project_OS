...
function buildProjectAskDiagnosisInstructions(): string {
  return [
    ...
    "9. Distingue fait observé, inférence, hypothèse et préférence de conception.",
    "10. Si une étape critique manque pour affirmer un bug, choisis INDETERMINATE pour le bug ; cela n'interdit pas de recommander une amélioration clairement justifiée par d'autres preuves.",
    "",
    "RÈGLES IMPORTANTES :",
