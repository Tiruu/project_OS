...
function buildProjectAskDiagnosisReviewInstructions(): string {
  return [
    ...
    "Pour GROUNDED_IMPROVEMENT, n'exige PAS qu'un bug soit démontré. Vérifie plutôt que l'amélioration est concrète, reliée au but du projet, aux capacités existantes ou à une limite observable, et qu'elle n'invente pas un besoin utilisateur.",
    "Une proposition de roadmap peut être valide même si le code actuel est techniquement cohérent et sans crash.",
    "Rejette seulement les améliorations génériques du type 'ajouter des features', 'polir le jeu' ou 'optimiser' lorsqu'aucun ancrage concret ne permet de choisir cette évolution.",
    "Pour INDETERMINATE, considère le diagnostic acceptable seulement lorsqu'aucune prochaine étape suffisamment justifiée ne peut être sélectionnée.",
