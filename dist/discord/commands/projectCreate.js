...
export const projectCreateCommand = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName("type").setDescription("Type de projet").setRequired(true))
    ...
    async execute(interaction) {
        ...
        const technologiesInput = interaction.options.getString("technologies", true);
