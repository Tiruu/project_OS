...
export async function askProjectWithAI(
  ...
  const instructions = [
    ...
    "2. Une décision, tâche ou activité Project OS décrit l'état enregistré mais ne prouve pas le comportement du code.",
    "3. Le journal, README et autres documents peuvent contenir de l'historique ou des descriptions obsolètes ; ils ne remplacent jamais le code actuel.",
    "4. Une affirmation documentaire disant qu'une fonction existe, qu'une ligne contient un appel ou qu'un comportement est actuel doit être vérifiée dans le contenu du fichier concerné avant d'être présentée comme un fait.",
    "5. N'invente jamais une ligne, une fonction ou une référence de fichier à partir d'un document qui la mentionne.",
    "",
